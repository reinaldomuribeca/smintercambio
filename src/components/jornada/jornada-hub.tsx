...
import { ArrowLeft, Plane, FileCheck2, Luggage, ChevronRight } from 'lucide-react'
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {JORNADAS.map(({ slug, titulo, descricao, icon: Icon, border, hover, iconBg, iconColor }) => {
              const concluido =
                slug === 'fechamento' ? jornada.fechamentoConcluido : jornada.preparacaoConcluida
                ...
                >
                  ...
                  {concluido && (
                    <div className="pointer-events-none absolute inset-0">
                      <div className="absolute left-1/2 top-1/2 w-[200%] -translate-x-1/2 -translate-y-1/2 -rotate-45 bg-green-500 py-2 text-center text-[10px] font-bold uppercase tracking-wider text-white shadow-md">
                        Etapa 100% Concluída
                      </div>
                    </div>
                  )}
